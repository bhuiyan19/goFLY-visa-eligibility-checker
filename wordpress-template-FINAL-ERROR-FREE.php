<?php
/*
Template Name: AI Visa Eligibility Checker – ERROR FREE FINAL
*/
get_header();
?>
...
.tool-loading{
 ...
 z-index:10;backdrop-filter:blur(5px);border-radius:28px;transition:opacity 0.3s ease;
}
...
<div class="container tool-container">
 <div class="tool-box">
  <!-- Loading State - Auto hides after 2 seconds -->
