<?php
/**
 * Visa Checker API - Updated with Email Notification Support
 * Form ID: 12
 * Handles First Name, Phone, Email, Country ID, Difficulty, Score, Percentage, Q&A
 * Fixed browser field + Enhanced email notification hooks
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    send_response(true, 'API is ready!', [
        ...
        'email_hooks' => 'Multiple hooks enabled for email'
    ]);
}
...
// Get browser from server (not from data)
